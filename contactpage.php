        ...
        <div class="container" id="contact">
            ...
            <div class="row" style="margin-top: 30px;">
                ...
                <form  action="contact.php" method="POST">
                    <input type="text" class="form-control form-control" placeholder="Name" name="username">
                </div>
                <div class="col-md-4 py-3 py-md-0">
                    <input type="text" class="form-control form-control" placeholder="Email" name="email">
                </div>
                <div class="col-md-4 py-3 py-md-0">
                    <input type="number" class="form-control form-control" placeholder="Phone" name="phone">
                </div>
               <div class="form-group" style="margin-top: 30px;">
                <textarea class="form-control" id=""rows="5" placeholder="Message" name="message"></textarea>
            </div>

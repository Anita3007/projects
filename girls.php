...
<body>
    ...
    <div class="container" id="product-cards">
        <div class="row" style="margin-top: 30px;">
            ...
            <div class="col-md-3 py-3 py-md-0">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h3>Long light blue  red dots frok </h3>
                        <!-- <p>Lorem ipsum dolor sit amet.</p> -->
                        <div class="star">
                            <i class="fas fa-star checked"></i>
                            <i class="fas fa-star checked"></i>
        ...
        <div class="row" style="margin-top: 30px;">
            ...
            <div class="col-md-3 py-3 py-md-0">
                <div class="card">
                    <img src="./image/g7jpg.jpg" alt="">
                    <div class="card-body">
                        <h3>Light Blue frok</h3>
                        <!-- <p>Lorem ipsum dolor sit amet.</p> -->
                        <div class="star">
                            <i class="fas fa-star checked"></i>
                            <i class="fas fa-star checked"></i>
        ...
        <div class="row" style="margin-top: 30px;">
            <div class="col-md-3 py-3 py-md-0">
                <div class="card">
                    <img src="./image/g10.jpeg" alt="">
                    <div class="card-body">
                        <h3>Light Pink Fork with jacket</h3>
                        <!-- <p>Lorem ipsum dolor sit amet.</p> -->
                        <div class="star">
                            <i class="fas fa-star checked"></i>
                            <i class="fas fa-star checked"></i>

        ...
        <div class="row" style="margin-top: 30px;">
            ...
            <div class="col-md-3 py-3 py-md-0">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h3>White lining shirt and short pant with black tie</h3>
                        <!-- <p>Lorem ipsum dolor sit amet.</p> -->
                        <div class="star">
                            <i class="fas fa-star checked"></i>
                            <i class="fas fa-star checked"></i>
            ...
            <div class="col-md-3 py-3 py-md-0">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h3>Brown night dress for boys</h3>
                        <!-- <p>Lorem ipsum dolor sit amet.</p> -->
                        <div class="star">
                            <i class="fas fa-star checked"></i>
                            <i class="fas fa-star checked"></i>
        ...
        <div class="row" style="margin-top: 30px;">
            ...
            <div class="col-md-3 py-3 py-md-0">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h3> Blue sweatshirt with pant & cap</h3>
                        <!-- <p>Lorem ipsum dolor sit amet.</p> -->
                        <div class="star">
                            <i class="fas fa-star checked"></i>
                            <i class="fas fa-star checked"></i>
            ...
            <div class="col-md-3 py-3 py-md-0">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h3>Shadhi wear shirt and pant with belt</h3>
                        <!-- <p>Lorem ipsum dolor sit amet.</p> -->
                        <div class="star">
                            <i class="fas fa-star checked"></i>
                            <i class="fas fa-star checked"></i>
            ...
            <div class="col-md-3 py-3 py-md-0">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h3>Pinkish shirt and pant with coat</h3>
                        <!-- <p>Lorem ipsum dolor sit amet.</p> -->
                        <div class="star">
                            <i class="fas fa-star checked"></i>
                            <i class="fas fa-star checked"></i>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 footer-links">
                    ...
                    <ul>
                      ...
                      <li><strong><a href="#">Services</a></strong></li>
                ...
                <div class="col-lg-3 col-md-6 footer-links">
                    <h4>Our Services</h4>
                    <ul>
                        <li><strong><a href="#">Smart phone</a></strong></li>
                        <li><strong><a href="#">Smart watch</a></strong></li>
                        <li><strong><a href="#">Airpods</a></strong></li>
                    </ul>
                </div>
                <div class="col-lg-3 col-md-6 footer-links">
